...
const whyChooseUs = [
  {
    ...
    description: 'Strategies designed with your bottom line in mind.',
    icon: BarChart3,
  },
  {
    title: 'Transparent Reporting',
    description: 'Real-time analytics and clear performance reports.',
    icon: ShieldCheck,
  },
  {
  ...
  },
  {
    ...
    description: 'No cookie-cutter plans. Custom strategies for your goals.',
    icon: Users,
  },
  {
    title: 'Data-Driven Execution',
    description: 'Decisions backed by data, not just intuition.',
    icon: Target,
  },
  {
    title: 'Dedicated Support',
    description: 'A team that cares about your success as much as you do.',
    icon: MessageSquare,
  },
]
...
const testimonials = [
  ...
  },
  {
    ...
    content: 'The social media strategy they implemented brought us customers we never thought we could reach.',
    rating: 5,
  },
  {
    name: 'Amit Sharma',
    role: 'Real Estate Agent',
    content: 'Their Local SEO expertise put us on the map—literally. We are now top-ranked in our area.',
    rating: 5,
  },
]
    ...
    <div className="flex flex-col gap-32 pb-32 bg-mesh">
      ...
      <section className="relative min-h-[95vh] flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="aura-primary bottom-[-20%] right-[-10%] animate-pulse delay-1000" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto text-center space-y-16">
            ...
            <div className="space-y-8">
              ...
              >
                Scale <br />
                <span className="text-primary drop-shadow-[0_0_80px_rgba(var(--primary),0.6)]">Beyond</span> <br />
                Limits
              </motion.h1>
              ...
              >
                Precision-engineered digital strategies for businesses that demand <span className="text-foreground font-bold underline decoration-primary/30 decoration-8 underline-offset-8">exponential growth</span> and market dominance.
              </motion.p>
            </div>
            ...
            >
              <p className="text-[10px] font-black uppercase tracking-[0.5em] text-muted-foreground/50">Trusted by Industry Leaders</p>
              <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
                {['TechNova', 'GlobalFlow', 'NexusCore', 'Zenith', 'Apex'].map((brand) => (
                  <span key={brand} className="text-3xl md:text-4xl font-black tracking-tighter uppercase italic">{brand}</span>
                ))}
              </div>
            </motion.div>
            ...
            >
              <Button size="lg" className="h-20 px-14 text-2xl font-black gap-4 w-full sm:w-auto rounded-full shadow-[0_0_40px_rgba(var(--primary),0.5)] hover:scale-105 transition-all duration-500" asChild>
                <Link href="/contact">
                  Start Scaling
                  <ArrowRight className="w-8 h-8" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="h-20 px-14 text-2xl font-black gap-4 w-full sm:w-auto border-2 rounded-full glass hover:bg-primary/10 transition-all duration-500" asChild>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative p-12 rounded-[40px] glass-card hover:border-primary/50 transition-all duration-700 overflow-hidden"
            >
              ...
              <div className="relative space-y-8">
                <div className="w-20 h-20 bg-primary/10 rounded-3xl flex items-center justify-center text-primary group-hover:scale-110 group-hover:rotate-6 transition-transform duration-500">
      ...
      <section className="container mx-auto px-4 py-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4 p-12 rounded-[60px] glass-card space-y-8 group">
            ...
            <h4 className="text-2xl font-black uppercase tracking-tight">ROI Focused</h4>
            <p className="text-muted-foreground font-light">Every rupee spent is tracked and optimized for maximum returns.</p>
          </div>
          ...
          <div className="md:col-span-4 p-12 rounded-[60px] glass-card space-y-8 group">
            ...
            <h4 className="text-2xl font-black uppercase tracking-tight">Transparency</h4>
            <p className="text-muted-foreground font-light">Real-time reporting and honest communication at every step.</p>
          </div>
          ...
          <div className="md:col-span-4 p-12 rounded-[60px] glass-card space-y-8 group">
            ...
            <h4 className="text-2xl font-black uppercase tracking-tight">Agility</h4>
            <p className="text-muted-foreground font-light">We adapt faster than the algorithms to keep you ahead.</p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-24">
        <div className="text-center space-y-8 mb-24">
          ...
          <h3 className="text-6xl md:text-8xl font-black tracking-tighter uppercase">How We <span className="text-primary">Win</span></h3>
        </div>
        ...
        <div className="max-w-5xl mx-auto p-20 rounded-[80px] glass-card relative overflow-hidden">
          ...
          <div className="text-center space-y-12">
            ...
            <p className="text-3xl md:text-5xl font-light font-serif italic leading-tight">
              "AMPLIZO transformed our digital presence. In just 3 months, our leads increased by 250% and our brand authority reached new heights."
            </p>
            <div className="space-y-2">
              <div className="text-2xl font-black uppercase tracking-widest">Sanjay Verma</div>
              <div className="text-primary font-bold uppercase tracking-widest text-xs">CEO, TechNova Solutions</div>
            </div>
          </div>
        </div>
      </section>
